...
namespace MarsFramework.Pages
{
    internal class ShareSkill 
    {
        ...
        internal void EnterShareSkill()
        {
            ...
            autoIt.Send("{ENTER}");
            autoIt.Sleep(2000);
            var FileSplitText = WorkSampleFileName.Text.Split('.');
            var FileSplitTextName = FileSplitText[0];
            ...
            GlobalDefinitions.SaveScreenShotClass.SaveScreenshot(GlobalDefinitions.driver, "ShareSkillScreenshot"); 
